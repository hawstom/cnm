...
(defun insblk
  ...
  ; (if (= (cdr(assoc 0(entget(entlast)))) "TEXT")(command "._ddedit" (entlast)))
  (vrstor)(errrst)(princ)
)
...
(defun c:haws-REV     ()(insblk "delta"     "DELTA"                    "0"  27))
...
(defun c:haws-TCL     ()(insblk "l-tcelev"  "ANNOMISC"                 "P"  27))
(defun c:haws-TCR     ()(insblk "r-tcelev"  "ANNOMISC"                 "P"  27))
