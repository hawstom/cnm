...
(hcnm-define-command-alias '("LayLk" "LK" "Custompgp" ""))
...
(hcnm-define-lisp-alias '("haws-lm" "lm" "Tools" ""))
...
(hcnm-define-lisp-alias '("haws-ul" "ul" "Tools" ""))
...
(hcnm-define-lisp-alias '("haws-cr" "cr" "Tools" ""))
(hcnm-define-lisp-alias '("haws-copyrot" "copyrot" "Tools" ""))
...
(hcnm-define-lisp-alias '("haws-bx" "bx" "Tools" ""))
