...
(hcnm-define-command-alias '("CopyToLayer" "Clone" "Custompgp" "Try the CCC shortcut."))
...
(hcnm-define-lisp-alias '("haws-dimtixtoggle" "xx" "Tools" ""))
...
(hcnm-define-lisp-alias '("haws-vsr" "vsr" "Tools" ""))
...
(hcnm-define-lisp-alias '("haws-aliasmanage" "hawsalias" "Tools" "Use CAM (CNMAlias)"))
