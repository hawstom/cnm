    ...
    *hcnm-cnmprojectroot*
     (cond
       ...
       (t
        ...
        ;;Set *hcnm-cnmprojectroot* BEFORE calling hcnm-initialize-project
        ;;to prevent infinite recursion if hcnm-initialize-project calls
        ;;functions that internally call hcnm-proj.
        (setq *hcnm-cnmprojectroot* dwgdir)
